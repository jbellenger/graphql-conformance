...
const BIN = path.join(__dirname, 'target', 'release', 'conformer');
let tmpDir;

beforeEach(() => {
  tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), 'harness-ag-test-'));
});
...
describe('async-graphql conformer-harness', () => {
